      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <div className="lg:pr-10">
          ...
          <h5 className="mb-4 text-4xl font-extrabold leading-none">
           GulSpider solution pv ltd
          </h5>
          <p className="mb-6 text-gray-900">
            At GulSpider solution pv ltd, we are passionate about creating a dynamic space for
            ...
            with a global community, GulSpider solution pv ltd APP is the perfect platform for
            you.
          </p>
          <hr className="mb-5 border-gray-300" />
          <div className="flex items-center space-x-4">
            <a
              href="https://www.linkedin.com/in/rohith-n-41330137/"
              target="_blank"
